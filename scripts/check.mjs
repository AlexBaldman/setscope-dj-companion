...
const uiSystemCss = await readFile("src/ui-system.css", "utf8");
const roomSystem = await readFile("src/room-system.js", "utf8");
...
assert(designSystemLab.includes("roomManifest") && designSystemLab.includes("data-room-choice"), "Style Lab should preview every room identity");
assert(designSystemLabCss.includes(".asset-grid") && designSystemLabCss.includes(".room-switcher"), "Style Lab should provide responsive asset and room previews");
